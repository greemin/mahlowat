    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Befragung abschließen</h4>
            </div>
            <div class="modal-body">
                Möchtest du die Befragung abschließen?<br>
                Mit dem Bestätigen sendest du uns deine Antworten.<br>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" onclick="$('#savemodal').modal('hide');" style="width: 100px;"><span class="glyphicon glyphicon-remove"></span> Nein</button>
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="bottom-buffer top-buffer">
                ...
                <div class="text-right">
                    <hr />
                    <small>Du kannst die Befragung jederzeit <a href="index.php" title="Von vorn beginnen">neu starten</a></a>.<br /> Außerdem haben wir auch eine <a href="faq.php?from=mahlowat.php" onclick="gotoFAQPage(event, resultArray)" title="FAQ">FAQ-Seite</a>.</small>
                </div>
